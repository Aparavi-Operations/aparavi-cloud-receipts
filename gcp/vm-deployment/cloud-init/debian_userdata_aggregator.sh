...
./linux-installer-latest.run -- /APPTYPE=aggregator /BINDTO="preview.aparavi.com" /DBTYPE="mysql" /DBHOST="${db_addr}" /DBPORT="3306" /DBUSER="${db_user}" /DBPSWD="${db_passwd}" /SILENT /NOSTART
